document.addEventListener("DOMContentLoaded", function () {
    ...
    toDoButton.addEventListener("click", function () {
        ...
        li.innerHTML = "<span></span><button type = 'button'>X</button><button type = 'button'>Edit</button >";
        ...
        li.children[2].addEventListener("click", function () {
            ...
            li2.innerHTML = "<input type='text'><button type = 'button'>X</button><button type = 'button'>cancel</button><button type = 'button'>save</button >";
